(function(window, undefined) {
        ...
        webgazer.params.clmParams = webgazer.params.clmParams || {
            useWebGL: true
        };
        ...
        function loop() {
            ...
            function getDivPosition() {
                ...
                for (i = 1; i < 7; i++) {
                    ...
                    var divPosition = document.getElementById("div" + i);
                    var rect = divPosition.getBoundingClientRect();
                    // console.log(rect);
                    if (blueDotY > rect.top && blueDotX < rect.right && blueDotX > rect.left && blueDotY < rect.bottom) {
                        // if(blueDotX > rect.top && blueDotX < rect.top + rect.width && blueDotY < rect.bottom && blueDotY < rect.width){
                          divPosition.style.background = "lightgrey";
                          //divPosition.style.opacity = "1";
                          divPosition.style.animation = "fadeOut 5s forwards";

                        }
                        else {
                            divPosition.style.animation = "fadeOut 5s backwards";
                            //divPosition.style.opacity = "0.5";
                            divPosition.style.background = "white";
